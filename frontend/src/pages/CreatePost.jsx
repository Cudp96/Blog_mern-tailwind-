...
const CreatePost = () => {
    ...
    return (
        <section className='p-3 max-w-3xl min-h-screen mx-auto'>
            <h1 className='text-center text-3xl my-7 font-semibold'>Create Post</h1>
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                <div className='flex flex-col gap-4 sm:flex-row'>
                    <TextInput onChange={(e) =>
                        setFromData({ ...formData, title: e.target.value })
                    } type='text' placeholder='Title Required' id='title' required className='flex-1' />
                    <Select onChange={(e) => setFromData({ ...formData, category: e.target.value })}>
                        <option value='uncategorized'>Select Category</option>
                        <option value='webdevelopment'>Web Development</option>
                        <option value='machinelearning'>Machine Learning</option>
                        <option value='andrioddevelopment'>Andriod Development</option>
                ...
                <ReactQuill onChange={(value) => setFromData({ ...formData, content: value })} theme='snow' placeholder='Write something....' className='h-72 mb-12' required />
